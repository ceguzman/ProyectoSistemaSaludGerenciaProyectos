...
import co.edu.poli.salud.config.Constants;
import co.edu.poli.salud.domain.User;
import co.edu.poli.salud.repository.UserRepository;
import co.edu.poli.salud.security.AuthoritiesConstants;
import co.edu.poli.salud.service.MailService;
import co.edu.poli.salud.service.UserService;
import co.edu.poli.salud.service.dto.AdminUserDTO;
import co.edu.poli.salud.web.rest.errors.BadRequestAlertException;
import co.edu.poli.salud.web.rest.errors.EmailAlreadyUsedException;
import co.edu.poli.salud.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link co.edu.poli.salud.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
